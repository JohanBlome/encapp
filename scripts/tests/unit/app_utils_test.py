...
class TestAppUtils(unittest.TestCase):
    ...
    def test_install_ok_shall_verify_if_encapp_is_installed(self, mock_apps):
        ...
        self.assertTrue(encapp_tool.app_utils.install_ok(ADB_DEVICE_VALID_ID, 1))
        self.assertFalse(encapp_tool.app_utils.install_ok(ADB_DEVICE_VALID_ID, 1))
    ...
    def test_uninstall_app_shall_uninstall_encapp(self, mock_uninstall):
        ...
        mock_uninstall.assert_called_with(ADB_DEVICE_VALID_ID, "com.facebook.encapp", 1)
