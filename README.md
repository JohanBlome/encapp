...
This example also show a different feature: visualization. It is possible to show videos in a grid like pattern (layout is automatic). 
...
...
['testing_Cipher_Placeholder_2022-08-24_14_05/camera_parallel_files/encapp_6b406f7d-b28f-4b64-b2c4-94d8ab41487e.json', 'PATH/camera_parallel_files/encapp_XXX.json']
```

This example will run two encodings with the camera as source in parallell and show the viewfinder in fullscreen. 
