...
cdir=$(dirname "$0")
python3 ${cdir}/../scripts/encapp.py run ${cdir}/surface_transcoder.pbtxt ${cdir}/output_name.pbtxt -w /tmp/colortest.original
printf "\nAdding color1.pbtxt containing updated settings for color encoding\n"
python3 ${cdir}/../scripts/encapp.py run ${cdir}/surface_transcoder.pbtxt ${cdir}/output_name.pbtxt ${cdir}/color1.pbtxt -w /tmp/colortest.color1
